...
import (
	...
	"github.com/Bnei-Baruch/jukfs/pkg/blobstore/memory"
	"github.com/Bnei-Baruch/jukfs/pkg/blobstore/storagetest"
	"github.com/Bnei-Baruch/jukfs/pkg/test"
)

// TestMemoryStorage tests against an in-memory blobstore.
func TestMemoryStorage(t *testing.T) {
	storagetest.Test(t, func(t *testing.T) (blobstore.Storage, func()) {
