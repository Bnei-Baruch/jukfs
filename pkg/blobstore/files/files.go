...
/*
Package files implements the blobstore interface by storing each blob
...
"webdav".
*/
package files // import "github.com/Bnei-Baruch/jukfs/pkg/blobstore/files"
...
func (ds *Storage) StatBlobs(ctx context.Context, blobs []blob.Ref, fn func(blob.SizedRef) error) error {
	return blobstore.StatBlobsParallelHelper(ctx, blobs, fn, statGate, func(ref blob.Ref) (sb blob.SizedRef, err error) {
