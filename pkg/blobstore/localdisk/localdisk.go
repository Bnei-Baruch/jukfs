...
/*
Package localdisk registers the "filesystem" blobstore storage type,
...
*/
package localdisk // import "github.com/Bnei-Baruch/jukfs/pkg/blobstore/localdisk"
...
import (
	...
	"github.com/Bnei-Baruch/jukfs/internal/osutil"
	"github.com/Bnei-Baruch/jukfs/pkg/blob"
	"github.com/Bnei-Baruch/jukfs/pkg/blobstore"
	"github.com/Bnei-Baruch/jukfs/pkg/blobstore/files"
	"github.com/Bnei-Baruch/jukfs/pkg/blobstore/local"
...
// DiskStorage implements the blobstore.Storage interface using the
// local filesystem.
...
var (
	_ blobstore.Storage = (*DiskStorage)(nil)
...
func newFromConfig(_ blobstore.Loader, config jsonconfig.Obj) (storage blobstore.Storage, err error) {
...
func init() {
	blobstore.RegisterStorageConstructor("filesystem", blobstore.StorageConstructor(newFromConfig))
}
